      ...
      <div class="modal-dialog modal-dialog-centered modal-sm">
          <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  <form name="modal" style="font-size: 18px;">


                      <div class="col-12">
                          <label class="form-label" method="post" action="order.php"
                              style="color: black; font-weight: bold;">Total Payment:
              ...
              <div class="modal-footer">
                  <button type="button" class="btn btn-primary" id="print" disabled>Print</button>
