...
.dropdown:hover .dropbtn {
 ...
 <body>
  ...
  ">
  <!-- <div class="dropdown">
  <button class="dropbtn">Purchase Item</button>
  <div class="dropdown-content">
  <a href="restock.php">Restock Item</a>
  <a href="add-transaction.php">New Item</a>
  </div>
</div> -->
<a  href="add-transaction.php"><button class="dropbtn">Purchase Item</button></a>
    </div>
